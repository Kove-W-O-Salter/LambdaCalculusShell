...
/* package LambdaCalculusShell-1.0.0.0 */
#define VERSION_LambdaCalculusShell "1.0.0.0"
#define MIN_VERSION_LambdaCalculusShell(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)

/* package LambdaCalculus-1.0.0.0 */
#define VERSION_LambdaCalculus "1.0.0.0"
#define MIN_VERSION_LambdaCalculus(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)

/* package Yamp-1.0.0.0 */
#define VERSION_Yamp "1.0.0.0"
#define MIN_VERSION_Yamp(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "LambdaCalculusShell-1.0.0.0"

#define CURRENT_PACKAGE_KEY "LambdaCalculusShell-1.0.0.0"
